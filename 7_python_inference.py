...
def externalized_model(features) -> str:
  ...
  json_request = {'dataframe_split': {'columns':['casos', 'casospermil', 'hombres80', 'mujeres80', 'pobla80', 'pobla65', 'poblamid', 'pobladata', 'pobladens', 
...
# Prueba cumpliendo con business logic 
#{"event_id": "17cfe7d5-3cdb-4e62-861d-0371b79f16f2", 
#"data": [10200, 382.5, 0.5, 0.45, 0.32, 3.21, 62.34, 0.42, 0.61, 
#            52.67, 23.45, 60.52, 38.2, 19.7, 15.5, 45.1, 35.8, 1.23, 
#            192, 10.3, 0.45, 0.32, 68, 19.1, 22.2, 22.2, 19.3, 
#            1, 53, 0.6]}


# Prueba que no cumple business logic
